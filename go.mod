...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/github.com/emicklei/go-restful/otelrestful v0.40.0 // indirect
...
replace (
	...
	kubevirt.io/client-go => github.com/kubeovn/kubevirt-client-go v0.0.0-20230301060230-5aae21a9918b
)
