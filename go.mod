...
require (
	...
	k8s.io/sample-controller v0.27.13
...
require (
	...
	k8s.io/cluster-bootstrap v0.27.13 // indirect
	...
	k8s.io/cri-api v0.27.13 // indirect
	k8s.io/csi-translation-lib v0.27.13 // indirect
