...
require (
	...
	k8s.io/kube-aggregator v0.31.10 // indirect
	k8s.io/kube-openapi v0.31.10 // indirect
...
replace (
	...
	k8s.io/controller-manager => k8s.io/controller-manager v0.31.10
	k8s.io/cri-api => k8s.io/cri-api v0.31.10
	k8s.io/cri-client => k8s.io/cri-client v0.31.10
	k8s.io/csi-translation-lib => k8s.io/csi-translation-lib v0.31.10
	k8s.io/dynamic-resource-allocation => k8s.io/dynamic-resource-allocation v0.31.10
	k8s.io/endpointslice => k8s.io/endpointslice v0.31.10
	...
	k8s.io/mount-utils => k8s.io/mount-utils v0.31.10
	k8s.io/pod-security-admission => k8s.io/pod-security-admission v0.31.10
