...
.PHONY: talos-untaint-control-plane
talos-untaint-control-plane: untaint-control-plane

.PHONY: talos-install
talos-install: talos-untaint-control-plane
	...
	@echo ">>>>> Deleting taints of control-plane nodes..."
