...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1.SchemeGroupVersion.WithResource("vpc-ipsec-gateways"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kubeovn().V1().VpcIPsecGateways().Informer()}, nil
