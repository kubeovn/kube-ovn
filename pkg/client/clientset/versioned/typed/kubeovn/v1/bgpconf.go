...
// BgpConvesGetter has a method to return a BgpConfInterface.
// A group's client should implement this interface.
type BgpConvesGetter interface {
	BgpConves() BgpConfInterface
}

// BgpConfInterface has methods to work with BgpConf resources.
type BgpConfInterface interface {
	Create(ctx context.Context, bgpConf *kubeovnv1.BgpConf, opts metav1.CreateOptions) (*kubeovnv1.BgpConf, error)
	Update(ctx context.Context, bgpConf *kubeovnv1.BgpConf, opts metav1.UpdateOptions) (*kubeovnv1.BgpConf, error)
	Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error
	Get(ctx context.Context, name string, opts metav1.GetOptions) (*kubeovnv1.BgpConf, error)
...
func newBgpConves(c *KubeovnV1Client) *bgpConves {
	return &bgpConves{
		gentype.NewClientWithList[*kubeovnv1.BgpConf, *kubeovnv1.BgpConfList](
			...
			"",
			func() *kubeovnv1.BgpConf { return &kubeovnv1.BgpConf{} },
			func() *kubeovnv1.BgpConfList { return &kubeovnv1.BgpConfList{} },
		),
	}
}
