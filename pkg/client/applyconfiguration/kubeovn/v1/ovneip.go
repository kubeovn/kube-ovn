...
// OvnEipApplyConfiguration represents a declarative configuration of the OvnEip type for use
// with apply.
...
// OvnEip constructs a declarative configuration of the OvnEip type for use with
// apply.
...
// ExtractOvnEipFrom extracts the applied configuration owned by fieldManager from
// ovnEip for the specified subresource. Pass an empty string for subresource to extract
// the main resource. Common subresources include "status", "scale", etc.
// ovnEip must be a unmodified OvnEip API object that was retrieved from the Kubernetes API.
// ExtractOvnEipFrom provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractOvnEipFrom(ovnEip *kubeovnv1.OvnEip, fieldManager string, subresource string) (*OvnEipApplyConfiguration, error) {
	b := &OvnEipApplyConfiguration{}
	err := managedfields.ExtractInto(ovnEip, internal.Parser().Type("com.github.kubeovn.kube-ovn.pkg.apis.kubeovn.v1.OvnEip"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(ovnEip.Name)
...
// ExtractOvnEip extracts the applied configuration owned by fieldManager from
// ovnEip. If no managedFields are found in ovnEip for fieldManager, a
// OvnEipApplyConfiguration is returned with only the Name, Namespace (if applicable),
// APIVersion and Kind populated. It is possible that no managed fields were found for because other
// field managers have taken ownership of all the fields previously owned by fieldManager, or because
// the fieldManager never owned fields any fields.
// ovnEip must be a unmodified OvnEip API object that was retrieved from the Kubernetes API.
// ExtractOvnEip provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractOvnEip(ovnEip *kubeovnv1.OvnEip, fieldManager string) (*OvnEipApplyConfiguration, error) {
	return ExtractOvnEipFrom(ovnEip, fieldManager, "")
}

// ExtractOvnEipStatus extracts the applied configuration owned by fieldManager from
// ovnEip for the status subresource.
func ExtractOvnEipStatus(ovnEip *kubeovnv1.OvnEip, fieldManager string) (*OvnEipApplyConfiguration, error) {
	return ExtractOvnEipFrom(ovnEip, fieldManager, "status")
}
...
func (b *OvnEipApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
