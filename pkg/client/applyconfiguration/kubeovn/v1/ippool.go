...
func ExtractIPPoolFrom(iPPool *kubeovnv1.IPPool, fieldManager string, subresource string) (*IPPoolApplyConfiguration, error) {
	b := &IPPoolApplyConfiguration{}
	err := managedfields.ExtractInto(iPPool, internal.Parser().Type("com.github.kubeovn.kube-ovn.pkg.apis.kubeovn.v1.IPPool"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractIPPool(iPPool *kubeovnv1.IPPool, fieldManager string) (*IPPoolApplyConfiguration, error) {
...
func ExtractIPPoolStatus(iPPool *kubeovnv1.IPPool, fieldManager string) (*IPPoolApplyConfiguration, error) {
