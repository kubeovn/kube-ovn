...
// OvnSnatRuleApplyConfiguration represents a declarative configuration of the OvnSnatRule type for use
// with apply.
...
// OvnSnatRule constructs a declarative configuration of the OvnSnatRule type for use with
// apply.
func OvnSnatRule(name string) *OvnSnatRuleApplyConfiguration {
	b := &OvnSnatRuleApplyConfiguration{}
	b.WithName(name)
	b.WithKind("OvnSnatRule")
	b.WithAPIVersion("kubeovn.io/v1")
	return b
}

// ExtractOvnSnatRuleFrom extracts the applied configuration owned by fieldManager from
// ovnSnatRule for the specified subresource. Pass an empty string for subresource to extract
// the main resource. Common subresources include "status", "scale", etc.
// ovnSnatRule must be a unmodified OvnSnatRule API object that was retrieved from the Kubernetes API.
// ExtractOvnSnatRuleFrom provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractOvnSnatRuleFrom(ovnSnatRule *kubeovnv1.OvnSnatRule, fieldManager string, subresource string) (*OvnSnatRuleApplyConfiguration, error) {
	b := &OvnSnatRuleApplyConfiguration{}
	err := managedfields.ExtractInto(ovnSnatRule, internal.Parser().Type("com.github.kubeovn.kube-ovn.pkg.apis.kubeovn.v1.OvnSnatRule"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(ovnSnatRule.Name)
...
// ExtractOvnSnatRule extracts the applied configuration owned by fieldManager from
// ovnSnatRule. If no managedFields are found in ovnSnatRule for fieldManager, a
// OvnSnatRuleApplyConfiguration is returned with only the Name, Namespace (if applicable),
// APIVersion and Kind populated. It is possible that no managed fields were found for because other
// field managers have taken ownership of all the fields previously owned by fieldManager, or because
// the fieldManager never owned fields any fields.
// ovnSnatRule must be a unmodified OvnSnatRule API object that was retrieved from the Kubernetes API.
// ExtractOvnSnatRule provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractOvnSnatRule(ovnSnatRule *kubeovnv1.OvnSnatRule, fieldManager string) (*OvnSnatRuleApplyConfiguration, error) {
	return ExtractOvnSnatRuleFrom(ovnSnatRule, fieldManager, "")
}

// ExtractOvnSnatRuleStatus extracts the applied configuration owned by fieldManager from
// ovnSnatRule for the status subresource.
func ExtractOvnSnatRuleStatus(ovnSnatRule *kubeovnv1.OvnSnatRule, fieldManager string) (*OvnSnatRuleApplyConfiguration, error) {
	return ExtractOvnSnatRuleFrom(ovnSnatRule, fieldManager, "status")
}
...
func (b *OvnSnatRuleApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
