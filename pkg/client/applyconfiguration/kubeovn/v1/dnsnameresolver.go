...
// apply.
func DNSNameResolver(name string) *DNSNameResolverApplyConfiguration {
...
func ExtractDNSNameResolverFrom(dNSNameResolver *kubeovnv1.DNSNameResolver, fieldManager string, subresource string) (*DNSNameResolverApplyConfiguration, error) {
	b := &DNSNameResolverApplyConfiguration{}
	err := managedfields.ExtractInto(dNSNameResolver, internal.Parser().Type("com.github.kubeovn.kube-ovn.pkg.apis.kubeovn.v1.DNSNameResolver"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
...
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractDNSNameResolver(dNSNameResolver *kubeovnv1.DNSNameResolver, fieldManager string) (*DNSNameResolverApplyConfiguration, error) {
...
func ExtractDNSNameResolverStatus(dNSNameResolver *kubeovnv1.DNSNameResolver, fieldManager string) (*DNSNameResolverApplyConfiguration, error) {
...
func (b *DNSNameResolverApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *DNSNameResolverApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *DNSNameResolverApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *DNSNameResolverApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *DNSNameResolverApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *DNSNameResolverApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
...
func (b *DNSNameResolverApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
...
func (b *DNSNameResolverApplyConfiguration) WithSpec(value *DNSNameResolverSpecApplyConfiguration) *DNSNameResolverApplyConfiguration {
	b.Spec = value
	return b
}
...
func (b *DNSNameResolverApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *DNSNameResolverApplyConfiguration) GetAPIVersion() *string {
...
func (b *DNSNameResolverApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
