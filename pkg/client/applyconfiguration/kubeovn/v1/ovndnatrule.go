...
// OvnDnatRuleApplyConfiguration represents a declarative configuration of the OvnDnatRule type for use
// with apply.
...
// OvnDnatRule constructs a declarative configuration of the OvnDnatRule type for use with
// apply.
...
// ExtractOvnDnatRuleFrom extracts the applied configuration owned by fieldManager from
// ovnDnatRule for the specified subresource. Pass an empty string for subresource to extract
// the main resource. Common subresources include "status", "scale", etc.
// ovnDnatRule must be a unmodified OvnDnatRule API object that was retrieved from the Kubernetes API.
// ExtractOvnDnatRuleFrom provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractOvnDnatRuleFrom(ovnDnatRule *kubeovnv1.OvnDnatRule, fieldManager string, subresource string) (*OvnDnatRuleApplyConfiguration, error) {
	b := &OvnDnatRuleApplyConfiguration{}
	err := managedfields.ExtractInto(ovnDnatRule, internal.Parser().Type("com.github.kubeovn.kube-ovn.pkg.apis.kubeovn.v1.OvnDnatRule"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(ovnDnatRule.Name)
...
// ExtractOvnDnatRule extracts the applied configuration owned by fieldManager from
// ovnDnatRule. If no managedFields are found in ovnDnatRule for fieldManager, a
// OvnDnatRuleApplyConfiguration is returned with only the Name, Namespace (if applicable),
// APIVersion and Kind populated. It is possible that no managed fields were found for because other
// field managers have taken ownership of all the fields previously owned by fieldManager, or because
// the fieldManager never owned fields any fields.
// ovnDnatRule must be a unmodified OvnDnatRule API object that was retrieved from the Kubernetes API.
// ExtractOvnDnatRule provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractOvnDnatRule(ovnDnatRule *kubeovnv1.OvnDnatRule, fieldManager string) (*OvnDnatRuleApplyConfiguration, error) {
	return ExtractOvnDnatRuleFrom(ovnDnatRule, fieldManager, "")
}

// ExtractOvnDnatRuleStatus extracts the applied configuration owned by fieldManager from
// ovnDnatRule for the status subresource.
func ExtractOvnDnatRuleStatus(ovnDnatRule *kubeovnv1.OvnDnatRule, fieldManager string) (*OvnDnatRuleApplyConfiguration, error) {
	return ExtractOvnDnatRuleFrom(ovnDnatRule, fieldManager, "status")
}
...
func (b *OvnDnatRuleApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
