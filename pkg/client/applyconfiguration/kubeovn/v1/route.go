...
func (b *RouteApplyConfiguration) WithCIDR(value string) *RouteApplyConfiguration {
	b.CIDR = &value
	return b
}
...
func (b *RouteApplyConfiguration) WithNextHopIP(value string) *RouteApplyConfiguration {
	b.NextHopIP = &value
	return b
}
