...
// IptablesSnatRuleApplyConfiguration represents a declarative configuration of the IptablesSnatRule type for use
// with apply.
...
// IptablesSnatRule constructs a declarative configuration of the IptablesSnatRule type for use with
// apply.
func IptablesSnatRule(name string) *IptablesSnatRuleApplyConfiguration {
	b := &IptablesSnatRuleApplyConfiguration{}
	b.WithName(name)
	b.WithKind("IptablesSnatRule")
	b.WithAPIVersion("kubeovn.io/v1")
	return b
}

// ExtractIptablesSnatRuleFrom extracts the applied configuration owned by fieldManager from
// iptablesSnatRule for the specified subresource. Pass an empty string for subresource to extract
// the main resource. Common subresources include "status", "scale", etc.
// iptablesSnatRule must be a unmodified IptablesSnatRule API object that was retrieved from the Kubernetes API.
// ExtractIptablesSnatRuleFrom provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractIptablesSnatRuleFrom(iptablesSnatRule *kubeovnv1.IptablesSnatRule, fieldManager string, subresource string) (*IptablesSnatRuleApplyConfiguration, error) {
	b := &IptablesSnatRuleApplyConfiguration{}
	err := managedfields.ExtractInto(iptablesSnatRule, internal.Parser().Type("com.github.kubeovn.kube-ovn.pkg.apis.kubeovn.v1.IptablesSnatRule"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(iptablesSnatRule.Name)
...
// ExtractIptablesSnatRule extracts the applied configuration owned by fieldManager from
// iptablesSnatRule. If no managedFields are found in iptablesSnatRule for fieldManager, a
// IptablesSnatRuleApplyConfiguration is returned with only the Name, Namespace (if applicable),
// APIVersion and Kind populated. It is possible that no managed fields were found for because other
// field managers have taken ownership of all the fields previously owned by fieldManager, or because
// the fieldManager never owned fields any fields.
// iptablesSnatRule must be a unmodified IptablesSnatRule API object that was retrieved from the Kubernetes API.
// ExtractIptablesSnatRule provides a way to perform a extract/modify-in-place/apply workflow.
// Note that an extracted apply configuration will contain fewer fields than what the fieldManager previously
// applied if another fieldManager has updated or force applied any of the previously applied fields.
func ExtractIptablesSnatRule(iptablesSnatRule *kubeovnv1.IptablesSnatRule, fieldManager string) (*IptablesSnatRuleApplyConfiguration, error) {
	return ExtractIptablesSnatRuleFrom(iptablesSnatRule, fieldManager, "")
}

// ExtractIptablesSnatRuleStatus extracts the applied configuration owned by fieldManager from
// iptablesSnatRule for the status subresource.
func ExtractIptablesSnatRuleStatus(iptablesSnatRule *kubeovnv1.IptablesSnatRule, fieldManager string) (*IptablesSnatRuleApplyConfiguration, error) {
	return ExtractIptablesSnatRuleFrom(iptablesSnatRule, fieldManager, "status")
}
...
func (b *IptablesSnatRuleApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
