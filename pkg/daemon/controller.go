...
func newControllerBase(config *Configuration, podInformerFactory informers.SharedInformerFactory, nodeInformerFactory informers.SharedInformerFactory, kubeovnInformerFactory kubeovninformer.SharedInformerFactory) (*ControllerBase, error) {
	...
	controllerBase.protocol = util.CheckProtocol(node.Annotations[util.IpAddressAnnotation])

	providerNetworkInformer.Informer().AddEventHandler(cache.ResourceEventHandlerFuncs{
		AddFunc:    controllerBase.enqueueAddProviderNetwork,
		UpdateFunc: controllerBase.enqueueUpdateProviderNetwork,
		DeleteFunc: controllerBase.enqueueDeleteProviderNetwork,
	})
	subnetInformer.Informer().AddEventHandler(cache.ResourceEventHandlerFuncs{
		AddFunc:    controllerBase.enqueueAddSubnet,
		UpdateFunc: controllerBase.enqueueUpdateSubnet,
		DeleteFunc: controllerBase.enqueueDeleteSubnet,
	})
	podInformer.Informer().AddEventHandler(cache.ResourceEventHandlerFuncs{
		UpdateFunc: controllerBase.enqueuePod,
	})

	return controllerBase, nil
}

func (c *ControllerBase) enqueueAddProviderNetwork(obj interface{}) {
...
func (c *ControllerBase) enqueueUpdateProviderNetwork(old, new interface{}) {
...
func (c *ControllerBase) enqueueDeleteProviderNetwork(obj interface{}) {
...
func (c *ControllerBase) enqueueAddSubnet(obj interface{}) {
	c.subnetQueue.Add(subnetEvent{new: obj})
}

func (c *ControllerBase) enqueueUpdateSubnet(old, new interface{}) {
	c.subnetQueue.Add(subnetEvent{old: old, new: new})
}

func (c *ControllerBase) enqueueDeleteSubnet(obj interface{}) {
...
func (c *ControllerBase) enqueuePod(old, new interface{}) {
	oldPod := old.(*v1.Pod)
	newPod := new.(*v1.Pod)
