...
func ParseFlags() *Configuration {
	var (
		...
		argEnableSGCTFlush = pflag.Bool("enable-sg-ct-flush", false, "Flush stale conntrack entries when SecurityGroup rules change")
	)
	...
	config := &Configuration{
		...
		EnableSGCTFlush:           *argEnableSGCTFlush,
	}
