...
func ParseFlags() *Configuration {
	var (
		...
		argEnableMacvlanNodeLocalIP         = pflag.Bool("enable-macvlan-node-local-ip", true, "Add node IP to macvlan sub-interface for ARP/NDP responses; if enabled, failure to add IP will cause macvlan creation to fail")
	)
