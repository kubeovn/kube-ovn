...
func ensureVswitchPort(provider table.Provider, config ovs.VswitchPortConfig) error {
	if provider == nil {
...
func deleteVswitchPort(provider table.Provider, portName string) error {
	if provider == nil {
		return errors.New("vswitch table provider is nil")
	}
...
func cleanVswitchDuplicatePort(provider table.Provider, ifaceID, portName string) error {
	if provider == nil {
		return errors.New("vswitch table provider is nil")
	}
...
func getVswitchInterfacePodNs(provider table.Provider, ifaceID string) (string, error) {
	if provider == nil {
		return "", errors.New("vswitch table provider is nil")
	}
	var interfaces []vswitch.Interface
