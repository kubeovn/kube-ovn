...
func TestBandwidthRateToMbps(t *testing.T) {
	tests := []struct {
		...
		{name: "decimal exponent quantity", rate: intstr.FromString("1e6"), want: 1},
		...
		{name: "whitespace", rate: intstr.FromString(" 1024 "), wantErr: "must be an integer in Mbps or a non-negative Kubernetes quantity"},
		{name: "decimal without suffix", rate: intstr.FromString("1.5"), wantErr: "must be an integer in Mbps or a non-negative Kubernetes quantity"},
		{name: "invalid suffix", rate: intstr.FromString("1GB"), wantErr: "must be an integer in Mbps or a non-negative Kubernetes quantity"},
		{name: "invalid quantity", rate: intstr.FromString("fast"), wantErr: "must be an integer in Mbps or a non-negative Kubernetes quantity"},
