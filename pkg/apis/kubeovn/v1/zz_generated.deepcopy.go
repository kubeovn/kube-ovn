...
func (in *BgpConfSpec) DeepCopyInto(out *BgpConfSpec) {
	*out = *in
	...
	if in.AdvertiseFilter != nil {
		in, out := &in.AdvertiseFilter, &out.AdvertiseFilter
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VpcDynamicRouting) DeepCopyInto(out *VpcDynamicRouting) {
	*out = *in
	if in.Redistribute != nil {
		in, out := &in.Redistribute, &out.Redistribute
		*out = make([]RedistributeType, len(*in))
		copy(*out, *in)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VpcDynamicRouting.
func (in *VpcDynamicRouting) DeepCopy() *VpcDynamicRouting {
	if in == nil {
		return nil
	}
	out := new(VpcDynamicRouting)
	in.DeepCopyInto(out)
	return out
}
