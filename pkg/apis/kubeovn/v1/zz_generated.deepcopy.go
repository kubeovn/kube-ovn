...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in DualStackList) DeepCopyInto(out *DualStackList) {
	{
		in := &in
		*out = make(DualStackList, len(*in))
		for key, val := range *in {
			var outVal []string
			if val == nil {
				(*out)[key] = nil
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DualStackList.
func (in DualStackList) DeepCopy() DualStackList {
	if in == nil {
		return nil
	}
	out := new(DualStackList)
	in.DeepCopyInto(out)
	return *out
}
