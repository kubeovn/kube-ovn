...
func (suite *OvnClientTestSuite) testGetChassisByHost() {
	...
	t.Run("test get chassis by host with multiple chassis", func(t *testing.T) {
		...
		ops8, err := sbClient.ovsDbClient.Create(chassis8)
		require.NoError(t, err)
