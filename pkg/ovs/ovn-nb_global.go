...
func (c *OVNNbClient) DeleteNbGlobal() error {
	...
	op, err := c.call.Where(nbGlobal).Delete()
	if err != nil {
		klog.Error(err)
		return err
	}
...
func (c *OVNNbClient) GetNbGlobal() (*ovnnb.NBGlobal, error) {
	...
	err := c.call.WhereCache(func(_ *ovnnb.NBGlobal) bool {
		return true
...
func (c *OVNNbClient) UpdateNbGlobal(nbGlobal *ovnnb.NBGlobal, fields ...any) error {
	...
	op, err := c.call.Where(nbGlobal).Update(nbGlobal, fields...)
	if err != nil {
		klog.Error(err)
