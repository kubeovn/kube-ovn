...
func vswitchProvider(providers ...table.Provider) (table.Provider, error) {
...
func kubeOvnVswitchBridges(ctx context.Context, provider table.Provider) ([]vswitch.Bridge, error) {
...
func Bridges(providers ...table.Provider) ([]string, error) {
...
func BridgeExists(name string, providers ...table.Provider) (bool, error) {
...
func PortExists(name string, providers ...table.Provider) (bool, error) {
	provider, err := vswitchProvider(providers...)
	if err != nil {
		return false, err
	}
...
func GetQosList(podName, podNamespace, ifaceID string, providers ...table.Provider) ([]string, error) {
	provider, err := vswitchProvider(providers...)
	if err != nil {
		return nil, err
	}
...
func ClearPodBandwidth(podName, podNamespace, ifaceID string, providers ...table.Provider) error {
	provider, err := vswitchProvider(providers...)
	if err != nil {
		return err
	}
...
func ListInterfacePodMap(providers ...table.Provider) (map[string]string, error) {
	provider, err := vswitchProvider(providers...)
	if err != nil {
		return nil, err
	}
...
func CleanInterface(name string, providers ...table.Provider) error {
	provider, err := vswitchProvider(providers...)
	if err != nil {
		return err
	}
...
func CleanDuplicatePort(ifaceID, portName string, providers ...table.Provider) {
	provider, err := vswitchProvider(providers...)
	if err != nil {
		klog.Error(err)
		return
...
func ValidatePortVendor(port string, providers ...table.Provider) (bool, error) {
	provider, err := vswitchProvider(providers...)
	if err != nil {
		return false, err
	}
...
func GetInterfacePodNs(iface string, providers ...table.Provider) (string, error) {
	provider, err := vswitchProvider(providers...)
	if err != nil {
		return "", err
	}
...
func ConfigInterfaceMirror(globalMirror bool, open, iface string, providers ...table.Provider) error {
	if globalMirror {
		return nil
	}
	provider, err := vswitchProvider(providers...)
...
func ClearPortQosBinding(ifaceID string, providers ...table.Provider) error {
	provider, err := vswitchProvider(providers...)
	if err != nil {
		return err
	}
...
func ListExternalIDs(table string, providers ...table.Provider) (map[string]string, error) {
	provider, err := vswitchProvider(providers...)
	if err != nil {
		return nil, err
	}
...
func ListQosQueueIDs(providers ...table.Provider) (map[string]string, error) {
	provider, err := vswitchProvider(providers...)
	if err != nil {
		return nil, err
	}
