...
func (c *VswitchClient) ReconcileACLSamplingCollectorSet(config aclsampling.NodeConfig) error {
	...
	if err := transactTable(context.Background(), collectorTable, "acl-sampling-node-reconcile", operations); err != nil {
...
func (c *VswitchClient) cleanupACLSamplingCollectorSets() error {
	...
	if err := transactTable(context.Background(), collectorTable, "acl-sampling-node-cleanup", deleteOperations); err != nil {
