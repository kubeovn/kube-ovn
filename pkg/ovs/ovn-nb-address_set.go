...
func (c *OVNNbClient) CreateAddressSet(asName string, externalIDs map[string]string) error {
	...
	if err = c.Database.Table(&ovnnb.AddressSet{}).Create(context.Background(), "as-add", as); err != nil {
		klog.Error(err)
...
func (c *OVNNbClient) UpdateAddressSet(as *ovnnb.AddressSet, fields ...any) error {
	...
	if err := c.Database.Table(&ovnnb.AddressSet{}).Update(context.Background(), "as-update", as, as, fields...); err != nil {
		klog.Error(err)
...
func (c *OVNNbClient) DeleteAddressSet(asName ...string) error {
	...
	if err := c.Database.Table(&ovnnb.AddressSet{}).Delete(context.Background(), "as-del", modelList...); err != nil {
		klog.Error(err)
...
func (c *OVNNbClient) GetAddressSet(asName string, ignoreNotFound bool) (*ovnnb.AddressSet, error) {
	...
	if err := c.Database.Table(&ovnnb.AddressSet{}).Get(ctx, as); err != nil {
...
func (c *OVNNbClient) ListAddressSets(externalIDs map[string]string) ([]ovnnb.AddressSet, error) {
	...
	if err := c.Database.Table(&ovnnb.AddressSet{}).Filter(ctx, addressSetFilter(externalIDs), &asList); err != nil {
		klog.Error(err)
