...
func (c *OVNNbClient) CreateAddressSet(asName string, externalIDs map[string]string) error {
	...
	if err = c.call.CreateAndTransact(context.Background(), "as-add", as); err != nil {
		klog.Error(err)
...
func (c *OVNNbClient) UpdateAddressSet(as *ovnnb.AddressSet, fields ...any) error {
	...
	if err := c.call.UpdateAndTransact(context.Background(), "as-update", as, as, fields...); err != nil {
		klog.Error(err)
...
func (c *OVNNbClient) DeleteAddressSet(asName ...string) error {
	...
	if err := c.call.DeleteAndTransact(context.Background(), "as-del", modelList...); err != nil {
		klog.Error(err)
...
func (c *OVNNbClient) BatchDeleteAddressSetByNames(asNames []string) error {
	...
	if err := c.call.ListWhereCache(ctx, func(as *ovnnb.AddressSet) bool {
...
func (c *OVNNbClient) DeleteAddressSets(externalIDs map[string]string) error {
	...
	if err := c.call.DeleteWhereCacheAndTransact(context.Background(), "ass-del", addressSetFilter(externalIDs)); err != nil {
		klog.Error(err)
...
func (c *OVNNbClient) GetAddressSet(asName string, ignoreNotFound bool) (*ovnnb.AddressSet, error) {
	...
	if err := c.call.Get(ctx, as); err != nil {
...
func (c *OVNNbClient) ListAddressSets(externalIDs map[string]string) ([]ovnnb.AddressSet, error) {
	...
	if err := c.call.ListWhereCache(ctx, addressSetFilter(externalIDs), &asList); err != nil {
		klog.Error(err)
