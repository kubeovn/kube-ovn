...
ENABLE_IPSEC_GW=${ENABLE_IPSEC_GW:-false}
...
VPC_IPSEC_IMAGE="vpc-ipsec-gateway"
...
metadata:
  annotations:
    controller-gen.kubebuilder.io/version: v0.20.1
  name: vpc-ipsec-gateways.kubeovn.io
spec:
  group: kubeovn.io
  names:
    kind: VpcIPsecGateway
    listKind: VpcIPsecGatewayList
    plural: vpc-ipsec-gateways
    shortNames:
    - vpc-ipsec-gw
    singular: vpc-ipsec-gateway
  scope: Cluster
  versions:
  - additionalPrinterColumns:
    - jsonPath: .spec.namespace
      ...
      openAPIV3Schema:
        ...
        properties:
          ...
          metadata:
            type: object
          spec:
            description: VpcIPsecGatewaySpec defines the desired state of VpcIPsecGateway.
            properties:
              affinity:
              ...
              annotations:
                ...
                type: object
              externalSubnet:
                description: External subnet used for Multus attachment (WAN / underlay
                  path to the remote peer).
                type: string
              lanIp:
                description: Static LAN IP for the gateway Pod on the internal subnet.
              ...
              namespace:
                ...
                type: string
              pskSecretRef:
                description: Reference to a Secret that holds the pre-shared key.
                properties:
                  key:
                    default: psk
                    description: Key in the Secret data that holds the PSK. Defaults
                      to "psk".
                    type: string
                  name:
                    ...
                    type: string
                  namespace:
                    description: Namespace of the Secret. Defaults to the gateway
                      workload namespace.
                    type: string
                required:
                - name
              ...
              remoteCIDRs:
                ...
                type: array
              remoteEndpoint:
                description: Remote IPsec peer address (public/underlay IP or hostname).
                type: string
              selector:
                description: 'Pod node selector entries in "key: value" form.'
                items:
                  type: string
                type: array
              subnet:
                description: Internal (LAN) subnet name for the gateway Pod. Immutable
                  after creation.
                type: string
              tolerations:
                ...
                type: array
              vpc:
                description: VPC name for the IPsec gateway. Immutable after creation.
                type: string
            required:
            - externalSubnet
            - lanIp
            ...
            type: object
          status:
            description: VpcIPsecGatewayStatus defines the observed state of VpcIPsecGateway.
            properties:
              affinity:
                ...
                type: object
              externalSubnet:
                description: External subnet currently attached.
                type: string
              lanIp:
                description: LAN IP address of the gateway Pod.
                type: string
              localCIDRs:
                description: Local CIDRs used as traffic selectors.
                items:
                  type: string
                type: array
              message:
                description: Message elaborates on Phase.
                type: string
              phase:
                description: Human-readable phase (e.g. Pending, Ready, Error).
                type: string
              ready:
                description: Ready is true when the gateway Pod is running and routes
                  are programmed.
                type: boolean
              remoteCIDRs:
                description: Remote CIDRs currently programmed into OVN.
                items:
                  type: string
                type: array
              remoteEndpoint:
                description: Remote peer endpoint currently programmed.
                type: string
              selector:
                description: Pod selector configured for the gateway.
                items:
                  type: string
                type: array
              tolerations:
                ...
                type: array
              workload:
                description: Workload information for the underlying StatefulSet.
                properties:
                  apiVersion:
                    type: string
                  kind:
...
apiVersion: v1
metadata:
  name: ovn-vpc-ipsec-config
  namespace: kube-system
  annotations:
    kubernetes.io/description: |
      kube-ovn vpc-ipsec common config
data:
  image: $REGISTRY/$VPC_IPSEC_IMAGE:$VERSION
---
kind: ConfigMap
apiVersion: v1
metadata:
  name: ovn-vpc-ipsec-gw-config
  namespace: kube-system
data:
  enable-vpc-ipsec-gw: "$ENABLE_IPSEC_GW"
---
kind: Deployment
apiVersion: apps/v1
metadata:
