            ...
            properties:
              ...
              healthCheck:
                ...
                properties:
                  intervalSeconds:
                    default: 5
                    description: IntervalSeconds is the probe interval. Defaults to
                      5.
                    format: int32
                    minimum: 1
                    type: integer
                  path:
                    ...
                    type: string
                  port:
                    description: Port is the HTTP port probed on each backend. It
                      may differ from the traffic port.
                    format: int32
                    maximum: 65535
                    minimum: 1
                    type: integer
                  timeoutSeconds:
                    default: 2
                    description: TimeoutSeconds is the probe timeout. Defaults to
                      2.
                    format: int32
                    minimum: 1
                    type: integer
