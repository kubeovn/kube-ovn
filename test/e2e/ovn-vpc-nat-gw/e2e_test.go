...
var _ = framework.Describe("[group:ovn-vpc-nat-gw]", func() {
	...
	framework.ConformanceIt("Test ovn eip fip snat dnat", func() {
		...
		framework.ExpectContainSubstring(nbLbDetailStr, multiDnat1Name)
		framework.ExpectContainSubstring(nbLbDetailStr, multiDnat2Name)
		...
		framework.ExpectNotContainSubstring(nbLbDetailStr, multiDnat1Name)
		framework.ExpectContainSubstring(nbLbDetailStr, multiDnat2Name)
		...
		framework.ExpectNotContainSubstring(nbLbDetailStr, multiDnat1Name)
		framework.ExpectNotContainSubstring(nbLbDetailStr, multiDnat2Name)
