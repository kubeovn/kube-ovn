...
false
  ...
  <tr>
   <td>bgpSpeaker.enableBgpLbVip</td>
   <td>bool</td>
   <td><pre lang="json">
false
</pre>
</td>
   <td>Enable announcing BGP LB VIP Service ingress IPs. Alias of enableLbSvcAnnounce; either one enables Service VIP announcements.</td>
  </tr>
  <tr>
