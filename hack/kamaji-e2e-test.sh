...
E2E_SOURCE_DIR=${E2E_SOURCE_DIR:-$SCRIPT_DIR/..}
...
require_text "$E2E_SOURCE_DIR/makefiles/e2e.mk" "KUBE_OVN_HCP_OVN_NB_ADDR"
require_text "$E2E_SOURCE_DIR/makefiles/e2e.mk" "KUBE_OVN_HCP_OVN_SB_ADDR"
require_text "$E2E_SOURCE_DIR/makefiles/e2e.mk" '$(GINKGO_E2E_RUN) --focus=CNI:Kube-OVN ./test/e2e/kamaji/kamaji.test'
reject_text "$E2E_SOURCE_DIR/makefiles/e2e.mk" "KUBE_OVN_KAMAJI_MGMT_VIP"
...
for source_file in \
  ...
  "$E2E_SOURCE_DIR/test/e2e/kamaji/kamaji_test.go" \
