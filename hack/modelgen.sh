...
# download vswitch/nb/sb/vtep schema files
...
curl -sSf -L --retry 5 -o vtep.ovsschema \
    https://raw.githubusercontent.com/openvswitch/ovs/refs/heads/branch-${OVS_VERSION}/vtep/vtep.ovsschema

# remove old generated files
rm -rfv pkg/ovsdb/vswitch pkg/ovsdb/ovnnb pkg/ovsdb/ovnsb pkg/ovsdb/vtep

# generate go code from vswitch/nb/sb/vtep schema files
...
go tool github.com/ovn-kubernetes/libovsdb/cmd/modelgen \
    -p vtep -o pkg/ovsdb/vtep vtep.ovsschema

# remove downloaded schema files
rm -fv vswitch.ovsschema ovn-nb.ovsschema ovn-sb.ovsschema vtep.ovsschema

# add generated files to git
git add pkg/ovsdb/vswitch pkg/ovsdb/ovnnb pkg/ovsdb/ovnsb pkg/ovsdb/vtep
