...
require_pattern makefiles/build.mk '^build-kube-ovn-almalinux10: gen-crd build-go$'
require_pattern makefiles/build.mk '^\.PHONY: build-kube-ovn-arm64-almalinux10$'
require_pattern makefiles/build.mk '^build-kube-ovn-arm64-almalinux10: gen-crd build-go-arm$'
require_pattern makefiles/build.mk '^\.PHONY: image-kube-ovn-almalinux10$'
require_pattern makefiles/build.mk '^image-kube-ovn-almalinux10: gen-crd build-go$'
require_pattern makefiles/build.mk '^\.PHONY: image-kube-ovn-arm64-almalinux10$'
require_pattern makefiles/build.mk '^image-kube-ovn-arm64-almalinux10: gen-crd build-go-arm$'
...
reject_pattern makefiles/build.mk 'almalinux10.*(LEGACY|DEBUG|dpdk)|((LEGACY|DEBUG|dpdk).*almalinux10)'
...
reject_pattern .github/workflows/build-kube-ovn-base.yaml 'almalinux10.*(legacy|debug|dpdk)|((legacy|debug|dpdk).*almalinux10)'
...
require_pattern .github/workflows/build-x86-image.yaml 'VERSION=\$\(cat VERSION\)\$\{\{ matrix\.image\.tag_suffix \}\}'
require_pattern .github/workflows/build-x86-image.yaml 'kubeovn/kube-ovn:\$TAG-almalinux10-amd64'
reject_pattern .github/workflows/build-x86-image.yaml 'almalinux10.*(legacy|debug|dpdk)|((legacy|debug|dpdk).*almalinux10)'
...
reject_pattern .github/workflows/build-arm64-image.yaml 'almalinux10.*(legacy|debug|dpdk)|((legacy|debug|dpdk).*almalinux10)'
